   ...
   if (isLoading) {
      return (
         <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-slate-500 font-medium animate-pulse">Loading receive order summary...</p>
         </div>
      );
   }
            ...
            <div className="flex items-center gap-3">
               ...
               <div>
                  <div className="flex items-center gap-2">
                     ...
                     <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Receive  Order</h1>
                  </div>
                  <p className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-0.5">View: {order.po_code}</p>
               </div>
            </div>
            <div className="flex items-center justify-end sm:justify-start">
               <span className="px-3 py-1.5 rounded-lg text-[10px] font-black text-slate-900 uppercase tracking-widest border border-slate-900 bg-slate-50 shadow-sm">
                  Verified & Received
               </span>
            </div>
         </div>
               ...
               <Card className="border-none bg-white shadow-sm">
                  ...
                  <CardContent className="pt-6 space-y-4">
                     ...
                     <div className="pt-2">
                        ...
                        <div className="relative overflow-hidden rounded-2xl p-5 sm:p-6 border border-slate-200 bg-slate-50/50 flex items-center group">
                           <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 bg-slate-900/5 rounded-full blur-2xl transition-all" />
                           <div className="relative z-10 w-full flex items-center justify-between">
                              <span className="text-[10px] sm:text-xs font-black uppercase text-slate-500 tracking-wider">
                                 Settled Amount
                              </span>
                              <span className="text-xl sm:text-xl font-black text-slate-900 tabular-nums tracking-tighter">
